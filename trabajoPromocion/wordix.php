...
/** Solicita al usuario un número para determinar si está entre el rango de valores
 * @param int $num
 * @return int
 */
...
/** Mensaje de bienvenida de el juego, que debe ingresar el nombre del jugador
...
/** Indica si la palabra agregada puede ser o no ingresada a la colección
 */
...
/** Ingresa el usuario una palabra de 5 letras para agregarle a la colección
 */
...
{   // array $vocales
    ...
    if ($puntajeIntento != 0) {
        $puntaje = $puntajeIntento + $puntajeLetra;
    } else {
        $puntaje = 0;
    }
